...
//
//	static File[] lazerFiles = {new File("art/sprites/laser_red.png"),
//			new File("art/sprites/laser_yellow.png"), 
//			new File("art/sprites/laser_blue.png"),
//			new File("art/sprites/laser_green.png"),
//			new File("art/sprites/laser_orange.png"),
//			new File("art/sprites/laser_purple.png")};
//
...
//			cloudImage = ImageIO.read(cloudFile);
	...
	public static void render(Graphics2D g, LazersMap map) {
		List<lazers.api.Color> colors = new LinkedList<lazers.api.Color>(getColors().keySet());
...
//		renderTargets(g, turn, nextTurn,getBellCurve(part3Tween),getSmoothCurve(part3Tween));
	 ...
	 * @param g - the graphics object to draw onto
	 */
	public static void renderBackground(Graphics2D g, LazersMap map) {
	 ...
	 * @throws IOException
	 */
	public static Map<lazers.api.Color, BufferedImage> loadIntoMap(File[] arr) throws IOException{
		Map<lazers.api.Color, BufferedImage> h = new HashMap<>();
		BufferedImage image;
		for(int i = 0; i < arr.length; i++){
			image = ImageIO.read(arr[i]);
			h.put(lazers.api.Color.values()[i], image);
		}
		return h;
	}
