...
public class Lazers extends JPanel implements GameWrapper, Runnable, KeyListener {
	...
	public LazersScenario scenario(File file) throws Exception {
		return new LazersScenario(file, -1);	//Team id is -1 for the server.  It will be a valid number for AIClients
	}
	...
	public void paint(Graphics g) {
		...
		if(simulation != null) {
			...
			LazersRenderer.render(g2d, turn, nextTurn, action, tweenPercent);
